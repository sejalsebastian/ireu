...
function filladd()
{
	 if(filltoo.checked == true) 
     {
            ...
            document.getElementById("pre_addr_line1").value = cor_addr_line11;
            document.getElementById("pre_addr_line2").value = cor_addr_line21;
            document.getElementById("pre_state").value = cor_state1;
            document.getElementById("pre_city").value = cor_city1;
            document.getElementById("pre_pincode").value = cor_pincode1;
...
jQuery(document).ready(function() {
	...
	jQuery('.form-wizard-next-btn').click(function() {
		...
		parentFieldset.find('.wizard-required').each(function(){
			...
			if( thisValue == "" || thisValue=="0" || thisValue=="default") {
