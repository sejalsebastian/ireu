  ...
  <section style="margin-top: 30px;">
    <div class="container">
      <div class="row">
        ...
        <?php include("./includes/aca_rese_info.php"); ?>
            <?php  foreach(  $aca_res_titles as  $aca_res_title) { ?>
          <h2 class="heading"><?php echo nl2br(utf8_encode(  $aca_res_title['ac_res_title'])); ?></h2><?php } ?>
          <p>
          <ul><?php  foreach(  $aca_res_subs as $aca_res_sub) { ?>
            <li><?php echo nl2br(utf8_encode( $aca_res_sub['ac_res_sub_point'])); ?></li>
        ...
        <div class="col-md-5">
          <img src="./img/aca_research.jpg"  class="img-fluid"  alt="" width="300px; height=300px;">
          </div>
      </div>
    </div>
  </section>
