            ...
            <div class="second_menu">
              <ul id="tabsJustified" class="nav nav-pills">
                ...
                <?php for ($i = 0; $i < count($programmesDetails); $i++) { ?>
                  ...
                  <li class="nav-item ">
                    <a href=""  data-target="<?php echo nl2br($programmesDetails[$i]['prog_id']); ?>" data-toggle="tab" onclick="sendprogID(<?php echo nl2br($programmesDetails[$i]['prog_id']); ?>)" class="nav-link  text-uppercase   <?php if ($i == 0) {
                                                                                                                                                                                                                                                            echo "active";
                                                                                                                                                                                                                                                          } ?> initial" style=" font-size: large;"><?php echo nl2br($programmesDetails[$i]['prog_name']); ?></a>
                                                                                                                                                                                                                                                          </li>
        ...
        <section class="programme_main">
          <div class="row">
            <div class="col-md-12">
             ...
             <p style="padding: 5px;">Established 2000, is into Research and Academic work, related to Higher Education and bridge gap between the Industry-Institute. Over One decade, the Centre has taken several consultancy, Research Project and Reports along with Coaching and Mentoring for New Age Careers. During the tenure at one of the Management Department, the Centre Director ( designated as Vice President ) undertook and organised series of talks by Corporate honcho, and Invited around 80 Talks by CEO, Vice President, Director, Chairman and Presidents of various MNC’s. This was the record of having such talks in bridging Industry-Institute gap, and addressing the much needed Corporate readiness.</p>
             <section class="experiential_learning mt-5">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                        <div class="card" style="box-shadow: 10px 10px 5px grey;" >
                          <div class="card-body">
                            <h6 class="card-title ml-auto" style="float:left;font-weight: bolder;">IRAdvanced Centre for Human Resources and Industry Interface</h6>
                          <div class="float-right">
                            <a class="grey-bg"  href="pdf/Advanced Centre .pdf" target="_blank" rel="noopener" style="margin-right:0px;">
                             <img src="./img/symbols/pdf-icon1.png" alt="" /></a></div>
                          </div>
                        </div>        
                       </div>
                    </div>
