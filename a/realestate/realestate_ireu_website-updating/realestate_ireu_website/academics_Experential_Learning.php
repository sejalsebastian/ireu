            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card-body">
                        ...
                        <?php include("./includes/aca_exper_info.php"); ?>
                        <?php  foreach( $ac_exps as $ac_exp) { ?>
                        <h5><?php echo (utf8_encode( $ac_exp['ac_exp_name'])); ?><a class="grey-bg" href="<?php echo nl2br(utf8_encode( $ac_exp['ac_exp_pdf'])); ?>" target="_blank" rel="noopener">
