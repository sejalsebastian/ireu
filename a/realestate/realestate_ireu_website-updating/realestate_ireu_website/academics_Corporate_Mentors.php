  ...
  <section style="margin-top: 30px;">
    <div class="container">
      <div class="row">
        ...
        <?php include("./includes/aca_cor_info.php"); ?>
            <?php  foreach( $ac_cors as $ac_cor) { ?>
          <h2 class="heading"><?php echo nl2br(utf8_encode($ac_cor['ac_corp_title'])); ?></h2><?php } ?>
          <p>
          <ul>
          <?php  foreach( $ac_corrs as $ac_corr) { ?>
            <li><?php echo nl2br(utf8_encode($ac_corr['ac_sub_corp_points'])); ?></h2><?php ?></li>
            <?php } ?>
          </ul>
          </p>
        </div>
        <div class="col-md-5">
          <!-- <img src="./img/aca_corp_ment1.jpeg"  class="img-fluid"  alt="" width="400px; height=400px;"> -->
          <img src="./img/aca_corp_ment2.jpeg"  class="img-fluid"  alt="" width="400px; height=400px;">
          </div>
      </div>
    </div>
  </section>
